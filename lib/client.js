...
function sendPacket (client, packet, cb) {
  ...
  switch (packet.cmd) {
    case 'connect':
      console.log('\x1b[37m %s \x1B[0m', '端發送封包', packet.cmd)
      break
    case 'disconnect':
      console.log('\x1b[37m %s \x1B[0m', '端發送封包', packet.cmd)
      break
    ...
    // 發送端
    case 'publish':
      console.log('\x1b[34m %s \x1B[0m', '發送端發送封包', packet.cmd)
      break
    case 'pubrel':
      console.log('\x1b[34m %s \x1B[0m', '發送端發送封包', packet.cmd)
      break
    // 訂閱端
    case 'subscribe':
      console.log('\x1b[31m %s \x1B[0m', '訂閱端發送封包', packet.cmd)
      break
    case 'unsubscribe':
      console.log('\x1b[31m %s \x1B[0m', '訂閱端發送封包', packet.cmd)
      break
    case 'puback':
      console.log('\x1b[31m %s \x1B[0m', '訂閱端回覆封包', packet.cmd)
      break
    case 'pubrec':
      console.log('\x1b[31m %s \x1B[0m', '訂閱端回覆封包', packet.cmd)
      break
  ...
  // console.log('\x1b[34m %s \x1B[0m',"發送封包 sendPacket",packet.cmd)
...
MqttClient.prototype._handlePacket = function (packet, done) {
  ...
  // console.log('\x1b[31m %s \x1B[0m',"收到封包_handlePacket",packet.cmd)
  ...
  switch (packet.cmd) {
    case 'connack':
      console.log('\x1b[37m %s \x1B[0m', '端收到封包', packet.cmd)
      break
    case 'pingresp':
      console.log('\x1b[37m %s \x1B[0m', '端收到封包', packet.cmd)
      break
    // 發送端
    case 'puback':
      console.log('\x1b[34m %s \x1B[0m', '發送端收到封包', packet.cmd)
      break
    case 'pubrec':
      console.log('\x1b[34m %s \x1B[0m', '發送端收到封包', packet.cmd)
      break
    ...
    // 訂閱端
    case 'suback':
      console.log('\x1b[31m %s \x1B[0m', '訂閱端收到封包', packet.cmd)
      break
    case 'unsuback':
      console.log('\x1b[31m %s \x1B[0m', '訂閱端收到封包', packet.cmd)
      break
    case 'publish':
      ...
      break
    case 'pubrel':
      console.log('\x1b[31m %s \x1B[0m', '訂閱端收到封包', packet.cmd, packet)
